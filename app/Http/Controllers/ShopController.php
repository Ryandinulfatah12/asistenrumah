...
class ShopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!Auth::check()){
            if(User::where('email', $request->email)->first() != null){
                flash(__('Email yang dimasukan sudah terdaftar!'))->error();
                return back();
            }
            if($request->password == $request->password_confirmation){
                ...
                flash(__('Sorry! Password tidak cocok.'))->error();
                return back();
            }
        }
        else{
        ...
        if(Shop::where('user_id', $user->id)->first() == null){
            ...
            if($shop->save()){
                ...
                flash(__('Akun Penyalurmu berhasil dibuat!'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($shop->save()){
            flash(__('Data Akun Penyalurmu berhasil diperbarui!'))->success();
            return back();
        }
    ...
    public function verify_form(Request $request)
    {
        if(Auth::user()->seller->verification_info == null){
            ...
            flash(__('Sorry! Kamu telah mengisikan sebelumnya.'))->error();
            return back();
        }
    }
    ...
    public function verify_form_store(Request $request)
    {
        ...
        if($seller->save()){
            flash(__('Permintaan Verifikasi Penyalur Berhasil dikirimkan!'))->success();

	...
	<div>
		...
		<div style="background: #eceff4;padding: 1.5rem;">
			...
			<table>
				...
				<tr>
					<td class="gry-color small">Telepon: {{ $generalsetting->phone }}</td>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
			<table>
				...
				@endphp
				<tr><td class="strong small gry-color">Dari Customer:</td></tr>
				...
				<tr><td class="gry-color small">Telepon: {{ $shipping_address->phone }}</td></tr>
			</table>
		</div>
	    ...
	    <div style="padding:0 1.5rem;">
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
					...
					<tr>
			            <th class="text-left strong">Biaya Pengambilan Pekerja AsistenRumah.com</th>
			            <td class="currency">IDR 100K</td>
						<p><i>Untuk info pembayaran Biaya Administrasi web akan kami kirim di Email.</i></p>
			        </tr>
		        </tbody>
		    </table>
	    </div>

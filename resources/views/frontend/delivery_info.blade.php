...
@section('meta_title','Check Pekerja')
@section('content')
                        ...
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                            ...
                            <div class="card mb-3">
                                <div class="card-header bg-white py-3">
                                    <h5 class="heading-6 mb-0">Pekerja dari {{ \App\GeneralSetting::first()->site_name }}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            @if (!empty($seller_products))
                                @foreach ($seller_products as $key => $seller_product)
                                    <div class="card mb-3">
                                        <div class="card-header bg-white py-3">
                                            <h5 class="heading-6 mb-0">Pekerja dari Penyalur {{ \App\Shop::where('user_id', $key)->first()->name }}</h5>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <table class="table-cart">
                                                        <tbody>
                                                            ...
                                                            <tr class="cart-item">
                                                                ...
                                                                <td class="product-name strong-600">
                                                                    <a href="{{ route('product', \App\Product::find($id)->slug) }}" target="_blank" class="d-block c-base-2">
                                                                        {{ \App\Product::find($id)->name }} ({{\App\Product::find($id)->category->name}})
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1">{{__('Lanjut Pesan')}}</a>
                                </div>
                            </div>
                        </form>
                    </div>

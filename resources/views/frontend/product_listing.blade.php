                            ...
                            <div class="box-content">
                                <div class="category-filter">
                                    <ul>
                                        ...
                                        @endif
                                        @if(isset($category_id))
                                            <li class="active"><a href="{{ route('products') }}">{{__('Lihat semua')}}</a></li>
                                ...
                                <div class="sort-by-box flex-grow-1">
                                    <div class="form-group">
                                        ...
                                        <div class="search-widget">
                                            <input class="form-control input-lg" type="text" name="q" placeholder="{{__('Cari pekerja..')}}" @isset($query) value="{{ $query }}" @endisset>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-4">
                                        <div class="sort-by-box px-1">
                                            <div class="form-group">
                                                <label>{{__('Urutkan dari')}}</label>
                                                <select class="form-control sortSelect" data-minimum-results-for-search="Infinity" name="sort_by" onchange="filter()">
                                                    <option value="1" @isset($sort_by) @if ($sort_by == '1') selected @endif @endisset>{{__('Terbaru/Pendatang')}}</option>
                                                    <option value="2" @isset($sort_by) @if ($sort_by == '2') selected @endif @endisset>{{__('Terlama')}}</option>
                                    ...
                                    <div class="col-4">
                                        <div class="sort-by-box px-1">
                                            <div class="form-group">
                                                <label>{{__('Penempatan')}}</label>
                                                <select class="form-control sortSelect" data-placeholder="{{__('Bersedia ditempatkan di')}}" name="brand" onchange="filter()">
                                                    <option value="">{{__('Bersedia ditempatkan di')}}</option>
                                    ...
                                    <div class="col-4">
                                        <div class="sort-by-box px-1">
                                            <div class="form-group">
                                                <label>{{__('Penyalur')}}</label>
                                                <select class="form-control sortSelect" data-placeholder="{{__('Semua Penyalur')}}" name="seller_id" onchange="filter()">
                                                    <option value="">{{__('Semua Penyalur')}}</option>
                                        ...
                                        <div class="product-box-2 bg-white alt-box my-md-2">
                                            <div class="position-relative overflow-hidden">
                                                ...
                                                <div class="product-btns clearfix">
                                                    ...
                                                    <a href="{{ route('product', $product->slug) }}" class="btn quick-view" title="Quick view">
                                                        <i class="la la-eye"></i>
                                                    </a>
                                                </div>
                                            </div>

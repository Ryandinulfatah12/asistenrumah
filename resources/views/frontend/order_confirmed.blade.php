...
@section('meta_title','Terimakasih')
@section('content')
    @php
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center py-4 border-bottom mb-4">
                                    ...
                                    <h1 class="h3 mb-3">{{__('Pekerja berhasil Dipesan!')}}</h1>
                                    <h2 class="h5 strong-700">{{__('Kode Pesanan:')}} {{ $order->code }}</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <table class="details-table table">
                                                <tr>
                                                    <td class="w-50 strong-600">{{__('Kode Pesanan')}}:</td>
                                                    <td>{{ $order->code }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-50 strong-600">{{__('Majikan')}}:</td>
                                                ...
                                                <tr>
                                                    <td class="w-50 strong-600">{{__('Alamat Pengantaran')}}:</td>
                                        ...
                                        <div class="col-md-6">
                                            <table class="details-table table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-secondary">Belum dibayar</td>
                                                </tr>
                                                <!-- <tr>
                                ...
                                <div>
                                    <h5 class="strong-600 mb-3 border-bottom pb-2">{{__('Detail Pesanan')}}</h5>
                                    <div>
                                        <table class="details-table table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{__('Job/Profesi')}}</th>
                                                    <th>{{__('Gaji Pekerja')}}</th>
                                                    <th>{{__('Admin Penyalur')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach ($order->orderDetails as $key => $orderDetail)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <strong>{{ __('Pekerja tidak tersedia') }}</strong>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            {{ $orderDetail->product->pdf }} (bayar ke penyalur)
                                                        </td>
                                                        <!-- <td>

                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                            <span class="p-1 bg-warning rounded text-uppercase text-bold">{{ __($detailedProduct->category->name) }}</span>
                            <div class="alert alert-light" role="alert">
                                <?php 
                                    $tags = explode(",", $detailedProduct->tags);
                                ?>
                            ...
                            <h1 class="product-title mb-2">
                                {{ __($detailedProduct->name) }} ({{ $detailedProduct->video_link }} tahun)
                                <p class="text-success">Pengalaman {{$detailedProduct->category->name}} {{$detailedProduct->video_provider}} tahun</p>
                            </h1>
                            ...
                            <div class="row align-items-center my-1">
                                ...
                                <div class="col-6 text-right">
                                    <ul class="inline-links inline-links--style-1">
                                        ...
                                        @if ($qty > 0)
                                            <li>
                                                <span class="badge badge-md badge-pill bg-green">{{__('Pekerja Siap Bekerja')}}</span>
                                            </li>
                                        @else
                                            <li>
                                                <span class="badge badge-md badge-pill bg-red">{{__('Belum Siap Bekerja')}}</span>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="card-body bg-white">
                                        <h5 class="card-title">Administrasi Pengambilan</h5>
                                        <p class="card-text">Biaya Administrasi ini merupakan biaya pengambilan pekerja dari penyalur ini.</p>
                                        <button type="button" class="btn btn-success btn-lg">{{ $detailedProduct->pdf }}</button>
                                    </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="card-body bg-success text-white">
                                        <h5 class="card-title">Gaji Pekerja ini <span class="badge bg-dark">bulanan</span> </h5>
                                        <p class="card-text">Gaji Pekerja bisa dinegosiasi antara Customer dengan Penyalur pekerja.</p>
                                        <button type="button" class="btn btn-warning btn-lg">{{ $detailedProduct->barcode }}</button>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-warning" role="alert">
                              <i class="fa fa-info" aria-hidden="true"></i> Untuk Negosiasi/Gaji dan Biaya Administrasi Pekerja bisa Ditanyakan Secara Personal ke Penyalur
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="sold-by col-auto">
                                    <small class="mr-2">{{__('Dari')}}: </small><br>
                                ...
                                @if (\App\BusinessSetting::where('type', 'conversation_system')->first()->value == 1)
                                    <div class="col-auto">
                                        <button class="btn" onclick="show_chat_modal()">{{__('Hubungi Penyalur')}}</button>
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="d-table-cell">
                                    ...
                                    @if ($qty > 0)
                                        ...
                                        <!-- <button type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="addToCart()">
                                            <span class="d-none d-md-inline-block"> {{__('Add to draft')}}</span>
                                        </button> -->
                                    @else
                                        <button type="button" class="btn btn-styled btn-base-3 btn-icon-left strong-700" disabled>
                                            {{__('Pekerja tidak tersedia')}}
                                        </button>
                                        <div class="alert alert-primary" role="alert">
                                        Sudah dipesan Customer dan sedang dalam Proses Follow Up oleh Penyalur
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <button type="button" class="btn pl-0 btn-link strong-700 text-danger" onclick="addToWishList({{ $detailedProduct->id }})"><i class="fa fa-heart" aria-hidden="true"></i> 
                                        {{__('Tambahkan ke favorit')}}
                                    </button>
                            ...
                            @if ($detailedProduct->added_by == 'seller')
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                                        <div class="product-description-label">{{__('Status Penyalur')}}:</div>
                                    </div>
                                    <div class="col-10">
                                        @if ($detailedProduct->user->seller->verification_status == 1)
                                            </i><span class="ml-2"><i class="fa fa-check-circle" style="color:green"></i></span> {{__('Penyalur terverifikasi!')}}
                                        @else
                                            <span class="ml-2"><i class="fa fa-times-circle" style="color:red"></i></span> {{__('Penyalur belum terverifikasi')}}
                                        @endif
                                    </div>
                                </div>
                            @endif
                ...
                <div class="col-xl-3 d-none d-xl-block">
                    <div class="seller-info-box mb-3">
                        <div class="sold-by position-relative">
                            ...
                            @endif
                            <div class="title">{{__('Informasi Penyalur')}}</div>
                            @auth
                                @if($detailedProduct->added_by == 'seller' && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                ...
                                @endif
                            @else
                                <h1 class="text-center"><i class="fa fa-eye-slash" aria-hidden="true"></i></h1>
                                <p>Harap Mendaftar/Login Terlebih dahulu...</p>
                            @endauth
                        ...
                        <div class="row no-gutters align-items-center">
                            @if($detailedProduct->added_by == 'seller')
                                <div class="col">
                                    <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}" class="d-block store-btn">{{__('Kunjungi')}}</a>
                                </div>
                                <div class="col">
                            ...
                            <div class="mb-3 product-box-3">
                                <div class="clearfix">
                                    ...
                                    <div class="product-details float-left">
                                        <span class="badge bg-secondary text-light">{{ $top_product->category->name }} | {{$top_product->video_link}} tahun</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mw-100 overflow--hidden">
                                                    ...
                                                    @else
                                                    Harap login terlebih dahulu untuk melihat detail info pekerja <a class="btn btn-link" href="{{route('user.login')}}">Klik untuk login</a>
                                                    @endauth
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="fluid-paragraph py-4">
                                        ...
                                        @if(count($detailedProduct->reviews) <= 0)
                                            <div class="text-center">
                                                {{ __('Belum ada ulasan untuk pekerja ini...') }}
                                            </div>
                                        @endif
                    ...
                    <div class="my-4 bg-white p-3">
                        <div class="section-title-1">
                            <h3 class="heading-5 strong-700 mb-0">
                                <span class="mr-4">{{__('Rekomendasi Pekerja lainnya')}}</span>
                            </h3>
                        </div>
                                ...
                                <div class="caorusel-card my-1">
                                    <div class="row no-gutters product-box-2 align-items-center">
                                        ...
                                        <div class="col-7 border-left">
                                            <div class="p-3">
                                                <span class="badge bg-secondary text-light">{{ $related_product->category->name }} | {{$related_product->video_link}} tahun</span>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title strong-600 heading-5">{{__('Tanyakan Sesuatu terkait pekerja')}}</h5>

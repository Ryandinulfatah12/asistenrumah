...
@section('meta_title','Data Pesanan')
@section('content')
                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('orders.index') }}">{{__('Data Pesanan')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <td>
                                                            <span class="badge badge--2 mr-4">
                                                                @if ($order->orderDetails->where('seller_id', Auth::user()->id)->first()->payment_status == 'paid')
                                                                    <i class="bg-green"></i> {{__('Sudah Dibayar')}}
                                                                @else
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="">
                                                                    <button onclick="show_order_details({{ $order->id }})" class="dropdown-item">{{__('Detail Pesanan')}}</button>

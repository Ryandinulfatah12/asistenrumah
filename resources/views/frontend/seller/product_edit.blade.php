...
@section('meta_title', 'Edit Data Pekerja')
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('seller.products.edit', $product->id) }}">{{__('Edit Pekerja')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name" placeholder="{{__('Nama')}}" value="{{ __($product->name) }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="18" max="60" class="form-control mb-3" name="video_link" value="{{ __($product->video_link) }}" placeholder="{{__('Usia Pekerja')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" id="nominalAdmin" value="{{ $product->pdf }}" name="pdf" placeholder="Nominal Admin" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" id="nominalGaji" value="{{ $product->barcode }}" name="barcode" placeholder="Nominal Gaji" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" max="40" value="{{ __($product->video_provider) }}" class="form-control mb-3" name="video_provider" placeholder="{{__('Pengalaman Kerja')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags[]" placeholder="Ketikan lalu enter" data-role="tagsinput" value="{{ $product->tags }}">
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                <div class="form-box-title px-3 py-2">
                                    {{__('Foto')}} <small class="text-danger">(Jika hanya memiliki 1 foto, isikan 3 kolom dibawah dengan foto sama)</small>
                                </div>
                                <div class="form-box-content p-3">
                            ...
                            <div class="form-box bg-white mt-4">
                                <div class="form-box-title px-3 py-2">
                                    {{__('Description')}} <small class="text-danger">tulis deskripsi se-rapi dan sejelas mungkin guna menarik costumer untuk memesan.</small>
                                </div>
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <textarea class="editor form-control" name="description">{{$product->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- HIDDEN INPUT -->
                            <input type="hidden" min="0" step="0.01" class="form-control mb-3" name="unit_price" placeholder="{{__('Unit Price')}} ({{__('Base Price')}})" value="{{$product->unit_price}}">
                            <input type="hidden" min="0" step="0.01" class="form-control mb-3" name="purchase_price" placeholder="{{__('Purchase Price')}}" value="{{$product->purchase_price}}" required>
                            <input type="hidden" min="0" step="0.01" class="form-control mb-3" name="tax" placeholder="{{__('Tax')}}" value="{{$product->tax}}">
                            <input type="hidden" min="0" step="0.01" class="form-control mb-3" name="tax_type" placeholder="{{__('Tax')}}" value="{{$product->tax_type}}">
                            <input type="hidden" min="0" step="0.01" class="form-control mb-3" name="discount" placeholder="{{__('Discount')}}" value="{{$product->discount}}">
                            <input type="hidden" min="0" step="0.01" class="form-control mb-3" name="discount_type" placeholder="{{__('Discount')}}" value="{{$product->discount_type}}">
                            <input type="hidden" min="0" step="1" class="form-control mb-3" name="current_stock" placeholder="{{__('Quantity')}}" value="{{$product->current_stock}}">
                            ...
                            <div class="form-box mt-4 text-right">
                                <button type="submit" class="btn btn-styled btn-base-1">{{ __('Update data Pekerja') }}</button>
                            </div>
                        </form>
                    </div>
                </div>

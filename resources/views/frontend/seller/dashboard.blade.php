                            ...
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center blue-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block sub-title">{{__('Pekerja terdaftar')}}</span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center yellow-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block sub-title">{{__('Pesanan dalam proses')}}</span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center red-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                       ...
                                       <!--  @php
                                        ...
                                        <span class="d-block sub-title">{{__('Pesanan menunggu konfirmasi')}}</span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center green-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block title heading-3 strong-400">{{ count(\App\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->get()) }}</span>
                                        <span class="d-block sub-title">{{__('Pesanan berhasil')}}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="bg-white mt-4 p-5 text-center">
                                    ...
                                    @if(Auth::user()->seller->verification_status == 0)
                                        <a href="{{ route('shop.verify') }}" class="btn btn-styled btn-base-1">{{__('Verifikasi Sekarang')}}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3 category-widget">
                                        ...
                                        <div class="text-center">
                                            <a href="{{ route('seller.products.upload')}}" class="btn pt-3 pb-1">{{__('Tambahkan Pekerja baru')}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="bg-white mt-4 p-4 text-center">
                                    <div class="heading-4 strong-700">{{__('Penyalur')}}</div>
                                    <p>{{__('Kelola dan atur Penyalur')}}</p>
                                    <a href="{{ route('shops.index') }}" class="btn btn-styled btn-base-1 btn-outline btn-sm">{{__('Buka pengaturan')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        @endif
                        <li>
                            <a href="{{ route('lowongan') }}" class="top-bar-item">{{__('Lowongan Kerja')}}</a>
                        </li>
                        ...
                        @auth
                        <li>
                            <a href="{{ route('dashboard') }}" class="top-bar-item">{{__('Panel Saya')}}</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('user.registration') }}" class="top-bar-item">{{__('Daftar')}}</a>
                        </li>
                        @endauth
                    </ul>
                </div>
                ...
                <div class="side-menu-header ">
                    ...
                    @auth
                        <div class="widget-profile-box px-3 py-4 d-flex align-items-center">
                            ...
                            <div class="name">Hai, {{ Auth::user()->name }}</div>
                        </div>
                    ...
                    @else
                        ...
                        <div class="side-login px-3 pb-3">
                            ...
                            <a href="{{ route('user.registration') }}">{{__('Daftar')}}</a>
                        </div>
                    @endauth
                </div>
                <div class="side-menu-list px-3">
                    ...
                    @if (Auth::check() && Auth::user()->user_type == 'seller')
                        <div class="sidebar-widget-title py-0">
                            <span>{{__('Menu Khusus Penyalur')}}</span>
                        </div>
                        <ul class="side-seller-menu">
                            ...
                            <li>
                                <a href="{{ route('shops.index') }}">
                                    <i class="la la-cog"></i>
                                    <span>{{__('Pengaturan Penyalur')}}</span>
                                </a>
                            </li>
                            ...
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="{{__('Saya sedang mencari...')}}" autocomplete="off">
                                        </div>
                                        <div class="form-group category-select d-none d-xl-block">
                                            <select class="form-control selectpicker" name="category">
                                                <option value="">{{__('Semua Profesi')}}</option>
                                                @foreach (\App\Category::all() as $key => $category)
                                ...
                                <!-- <div class="d-inline-block" data-hover="dropdown">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block">{{__('Draft')}}</span>
                                            @if(Session::has('cart'))
                    ...
                    <div class="col-lg-3 position-static">
                        <div class="category-sidebar" id="category-sidebar">
                            <div class="all-category">
                                <span>{{__('Kategori Pekerjaan')}}</span>
                                <a href="{{ route('categories.all') }}" class="d-inline-block">Lihat semua ></a>
                            </div>
                            <ul class="categories">

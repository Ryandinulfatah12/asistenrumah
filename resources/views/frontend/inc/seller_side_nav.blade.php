    ...
    <div class="widget mb-0">
        <div class="widget-profile-box text-center p-3">
            ...
            @if(Auth::user()->seller->verification_status == 1)
                <div class="name mb-0">Hai, {{ Auth::user()->name }} <span class="ml-2"><i class="fa fa-check-circle" style="color:green"></i></span></div>
                <span class="font-italic">Bergabung sejak {{\Carbon\Carbon::parse(Auth::user()->created_at)->diffForHumans()}}</span>
            @else
                <div class="name mb-0">{{ Auth::user()->name }} <span class="ml-2"><i class="fa fa-times-circle" style="color:red"></i></span></div>
                <p style="color: red;">Akun Penyalurmu belum disetujui admin :(</p>
            @endif
        </div>
            ...
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('orders.index') }}" class="{{ areActiveRoutesHome(['orders.index'])}}">
                        ...
                        <span class="category-name">
                            {{__('Data Pesanan')}} @if($orders > 0)<span class="ml-2" style="color:green"><strong>({{ $orders }} {{ __('New') }})</strong></span></span>@endif
                        </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('purchase_history.index') }}" class="{{ areActiveRoutesHome(['purchase_history.index'])}}">
                        <i class="la la-file-text"></i>
                        <span class="category-name">
                            {{__('Riwayat Pesanan')}} @if($delivery_viewed > 0 || $payment_status_viewed > 0)<span class="ml-2" style="color:green"><strong>({{ __(' Ada Notifikasi baru!') }})</strong></span>@endif
                        </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('reviews.seller') }}" class="{{ areActiveRoutesHome(['reviews.seller'])}}">
                        ...
                        <span class="category-name">
                            {{__('Review para Pekerja')}}@if($review_count > 0)<span class="ml-2" style="color:green"><strong>({{ $review_count }} {{ __('New') }})</strong></span>@endif
                        </span>
                    </a>
                </li>

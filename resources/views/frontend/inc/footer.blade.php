            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-top-box text-center">
                    <a href="{{ route('sellerpolicy') }}">
                        ...
                        <h4 class="heading-5">{{__('Syarat dan Ketentuan')}}</h4>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer-top-box text-center">
                    <a href="{{ route('supportpolicy') }}">
                        ...
                        <h4 class="heading-5">{{__('Mengapa harus Kami')}}</h4>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer-top-box text-center">
                    <a href="{{ route('returnpolicy') }}">
                        ...
                        <h4 class="heading-5">{{__('Cara memakai Situs')}}</h4>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-top-box text-center">
                    <a href="{{ route('profile') }}">
                        ...
                        <h4 class="heading-5">{{__('Profil saya')}}</h4>
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="d-inline-block d-md-block">
                            <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                                ...
                                <div class="form-group mb-0">
                                    <input type="email" class="form-control" placeholder="{{__('Email Anda...')}}" name="email" required>
                                </div>
                ...
                <div class="col-md-4">
                    <ul class="text-center my-3 my-md-0 social-nav model-2">
                        ...
                        <!-- @if ($generalsetting->google_plus != null)
                            <li>
                                <a href="{{ $generalsetting->google_plus }}" class="instagram" target="_blank" data-toggle="tooltip" data-original-title="Instagram">
                                    <i class="fa fa-instagram"></i>
                                </a>
                            </li>
                        @endif -->

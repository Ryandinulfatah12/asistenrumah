<div class="sidebar sidebar--style-3 no-border stickyfill p-0">
    <div class="widget mb-0">
            ...
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('purchase_history.index') }}" class="{{ areActiveRoutesHome(['purchase_history.index'])}}">
                        ...
                        <span class="category-name">
                            {{__('Riwayat Pesanan')}} @if($delivery_viewed > 0 || $payment_status_viewed > 0)<span class="ml-2" style="color:green"><strong>({{ __('Notifikasi baru!') }})</strong></span>@endif
                        </span>
                    </a>
                </li>
        ...
        <div class="widget-seller-btn pt-4">
            <a href="https://api.whatsapp.com/send/?phone=628111091312&text=%22Halo%20Admin%20AsistenRumah.com%20saya%20perlu%20bantuan%20nih..%22" class="btn btn-anim-primary w-100">Bantuan Livechat CS</a>
        </div>

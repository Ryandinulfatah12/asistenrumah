                        ...
                        <div class="card">
                            <div class="text-center px-35 pt-5">
                                <h1 class="heading heading-4 strong-500">
                                    {{__('Pesan Asisten Rumah Terpercaya di.')}} <a href="https://asistenrumah.com">AsistenRumah.com</a>
                                </h1>
                            </div>
                                    ...
                                    <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-right">
                                                <a href="{{ route('password.request') }}" class="link link-xs link--style-3">{{__('Lupa password?')}}</a>
                                            </div>
                                        </div>
                            ...
                            <div class="text-center px-35 pb-3">
                                <p class="text-md">
                                    {{__('Belum punya akunnya?')}} <a href="{{ route('user.registration') }}" class="strong-600">{{__('Daftar disini')}}</a>
                                </p>
                            </div>
                        </div>
                    </div>

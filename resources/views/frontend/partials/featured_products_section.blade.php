<section class="mb-4">
    <div class="container">
        <div class="px-2 py-4 p-md-4 shadow-sm" style="background-color: #1abc9c; opacity: 5;">
            <div class="section-title-1 clearfix">
                <h3 class="heading-5 strong-700 mb-0 float-left text-white">
                    <i class="fa fa-level-up" aria-hidden="true"></i> <span class="mr-4">{{__('Pekerja Sorotan!')}}</span>
                </h3>
            </div>
                        ...
                        <div class="product-card-2 card card-product shop-cards shop-tech">
                            <div class="card-body p-0">
                                ...
                                <div class="p-md-3 p-2 text-center">
                                    ...
                                    <div class="price-box">
                                        <span class="product-price strong-600 text-uppercase">{{ ($product->category->name) }}</span>
                                    </div>
                                    <span class="badge bg-secondary text-white">{{ ($product->video_link) }} tahun</span>
                                    <span class="badge bg-light">Pengalaman kerja {{ ($product->video_provider) }} tahun</span>

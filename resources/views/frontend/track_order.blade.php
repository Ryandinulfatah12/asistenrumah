...
@section('meta_title','Cek Pesanan')
@section('content')
                        ...
                        <form class="" action="{{ route('orders.track') }}" method="GET" enctype="multipart/form-data">
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('ID Pesanan')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{__('ID Pesanan')}}" name="order_code" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="text-right mt-4">
                                <button type="submit" class="btn btn-styled btn-base-1">{{__('Cek Sekarang')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <table class="details-table table">
                                    ...
                                    <tr>
                                        <td class="w-50 strong-600">{{__('Alamat')}}:</td>
                            ...
                            <div class="col-lg-6">
                                <table class="details-table table">
                                    <tr>
                                        <td class="w-50 strong-600">{{__('Tanggal')}}:</td>
                            ...
                            <div class="col-6">
                                <table class="details-table table">
                                    @if($orderDetail->product != null)
                                        <tr>
                                            <td class="w-50 strong-600">{{__('Pekerja yang dipesan')}}:</td>
                                            <td>{{ $orderDetail->product->name }} | {{ $orderDetail->product->unit }}</td>
                                        </tr>
                                        <tr>
                                            <td class="w-50 strong-600">{{__('Profesi')}}:</td>
                                            <td>{{ $orderDetail->product->category->name }}</td>
                                        </tr>
                                        <tr>
                                            <td class="w-50 strong-600">{{__('Dari Penyalur')}}:</td>

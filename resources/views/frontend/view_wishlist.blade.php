                        ...
                        <div class="row shop-default-wrapper shop-cards-wrapper shop-tech-wrapper mt-4">
                            @foreach ($wishlists as $key => $wishlist)
                                @if ($wishlist->product != null)
                                    <div class="col-md-3" id="wishlist_{{ $wishlist->id }}">
                                        <div class="card card-product mb-3 product-card-2">
                                            ...
                                            <div class="card-body text-center p-2">
                                                <div class="card-image">
                                                    <a href="{{ route('product', $wishlist->product->slug) }}" class="d-block"><img loading="lazy" class="mx-auto" src="{{ asset($wishlist->product->thumbnail_img) }}" width="80%">
                                                    </a>
                                                </div>
                                                ...
                                                <div>
                                                    <span class="badge bg-secondary text-white">{{ $wishlist->product->category->name }}</span>
                                                </div>

                                                <div class="star-rating star-rating-sm my-1">

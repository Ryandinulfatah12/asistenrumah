...
@section('meta_title','Informasi Pengantaran')
@section('content')
                ...
                <div class="row cols-delimited justify-content-center">
                    ...
                    <div class="col">
                        <div class="icon-block icon-block--style-1-v5 text-center active">
                            ...
                            <div class="block-content d-none d-md-block">
                                <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize">2. {{__('Dianter kemana?')}}</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_shipping_infostore') }}" role="form" method="POST">
                                ...
                                @if(Auth::check())
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">{{__('Nama Pemesan')}}</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">{{__('Alamat Lengkap')}}</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">{{__('Negara')}}</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    <label class="control-label">{{__('Kota/Kabupaten')}}</label>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">{{__('Nama Pemesan')}}</label>
                                                    <input type="text" class="form-control" name="name" placeholder="{{__('Nama Pemesan')}}" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">{{__('Alamat Lengkap')}}</label>
                                                    <input type="text" class="form-control" name="address" placeholder="{{__('Alamat Lengkap')}}" required>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1">{{__('Lanjut ke Info Pesanan')}}</a>
                                </div>
                            </div>
                            {{-- <div class="row align-items-center pt-4">
                                <div class="col-6">

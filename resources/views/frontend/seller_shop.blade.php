            ...
            <div class="row align-items-baseline">
                ...
                <div class="col-md-6">
                    <ul class="text-md-right mt-4 mt-md-0 social-nav model-2">
                        ...
                        @if ($shop->google != null)
                            <li>
                                <a href="{{ $shop->google }}" class="instagram social_a" target="_blank" data-toggle="tooltip" data-original-title="Google">
                ...
                <div class="col">
                    <div class="seller-shop-menu">
                        <ul class="inline-links">
                            <li @if(!isset($type)) class="active" @endif><a href="{{ route('shop.visit', $shop->slug) }}">{{__('Laman Utama')}}</a></li>
                            <li @if(isset($type) && $type == 'top_selling') class="active" @endif><a href="{{ route('shop.visit.type', ['slug'=>$shop->slug, 'type'=>'top_selling']) }}">{{__('Member Lama')}}</a></li>
                            <li @if(isset($type) && $type == 'all_products') class="active" @endif><a href="{{ route('shop.visit.type', ['slug'=>$shop->slug, 'type'=>'all_products']) }}">{{__('List Semua Pekerja')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="caorusel-card my-5">
                                        <div class="product-card-2 card card-product shop-cards shop-tech">
                                            <div class="card-body p-0">
                                                ...
                                                <div class="p-3">
                                                    <div class="price-box">
                                                        <span class="price strong-600">{{ $product->category->name }}</span>
                                                    </div>
                        ...
                        <div class="card product-box-1 mb-3">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="cart-add d-flex">
                                    ...
                                    <a href="{{ route('product', $product->slug) }}" class="btn btn-block btn-icon-left"><span class="d-none d-sm-inline-block">Lihat</span><i class="la la-eye ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>

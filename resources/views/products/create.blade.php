				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group" id="subsubcategory">
								<label class="col-lg-2 control-label">{{__('Usia')}}</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="video_provider" placeholder="{{__('Usia Pekerja')}}">
								</div>
							</div>
							...
							<div class="form-group" id="subsubcategory">
								<label class="col-lg-2 control-label">{{__('Pengalaman')}}</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="video_link" placeholder="{{__('Pengalaman Kerja')}}">
								</div>
							</div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="0" placeholder="{{__('Unit price')}}" name="unit_price" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Purchase price')}}</label>
								<div class="col-lg-7">
									<input type="number" min="0" value="0" placeholder="{{__('Purchase price')}}" name="purchase_price" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group" id="quantity">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="1" step="1" placeholder="{{__('Quantity')}}" name="current_stock" class="form-control" required>
								</div>
							</div>
							<br>

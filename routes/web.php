...
Route::post('/home/section/unggulan', 'HomeController@load_featured_section')->name('home.section.featured');
Route::post('/home/section/pekerja_terbaik', 'HomeController@load_best_selling_section')->name('home.section.best_selling');
Route::post('/home/section/profesi_home', 'HomeController@load_home_categories_section')->name('home.section.home_categories');
Route::post('/home/section/penyalur_terbaik', 'HomeController@load_best_sellers_section')->name('home.section.best_sellers');

// loker page
Route::get('/lowongan-kerja', 'HomeController@lokerPage')->name('lowongan');
...
Route::get('/pekerja/{slug}', 'HomeController@product')->name('product');
Route::get('/pekerja', 'HomeController@listing')->name('products');
...
Route::get('/search?penempatan={brand_slug}', 'HomeController@search')->name('products.brand');
Route::post('/product/variant_price', 'HomeController@variant_price')->name('products.variant_price');
// Route::get('/penyalur/visit/{slug}', 'HomeController@shop')->name('shop.visit');
// Route::get('/penyalur/visit/{slug}/{type}', 'HomeController@filter_shop')->name('shop.visit.type');

Route::get('/pesan', 'CartController@index')->name('cart');
...
Route::group(['middleware' => ['checkout']], function(){
	...
	Route::post('/checkout/check', 'CheckoutController@store_delivery_info')->name('checkout.store_delivery_info');
});
...
Route::get('/penempatan', 'HomeController@all_brands')->name('brands.all');
...
Route::get('/syarat-dan-ketentuan', 'HomeController@sellerpolicy')->name('sellerpolicy');
Route::get('/cara-memakai-situs', 'HomeController@returnpolicy')->name('returnpolicy');
Route::get('/mengapa-harus-kami', 'HomeController@supportpolicy')->name('supportpolicy');
...
Route::group(['middleware' => ['user', 'verified']], function(){
	...
	Route::post('/penyalur/update-profile', 'HomeController@seller_update_profile')->name('seller.profile.update');
...
Route::group(['prefix' =>'penyalur', 'middleware' => ['seller', 'verified']], function(){
	Route::get('/pekerja', 'HomeController@seller_product_list')->name('seller.products');
	Route::get('/pekerja/upload', 'HomeController@show_product_upload_form')->name('seller.products.upload');
	Route::get('/pekerja/{id}/edit', 'HomeController@show_product_edit_form')->name('seller.products.edit');
...
Route::group(['middleware' => ['auth']], function(){
	Route::post('/pekerja/store/','ProductController@store')->name('products.store');
	Route::post('/pekerja/update/{id}','ProductController@update')->name('products.update');
	Route::get('/pekerja/destroy/{id}', 'ProductController@destroy')->name('products.destroy');
	Route::get('/pekerja/duplicate/{id}', 'ProductController@duplicate')->name('products.duplicate');
	Route::post('/pekerja/sku_combination', 'ProductController@sku_combination')->name('products.sku_combination');
	Route::post('/pekerja/sku_combination_edit', 'ProductController@sku_combination_edit')->name('products.sku_combination_edit');
	Route::post('/pekerja/featured', 'ProductController@updateFeatured')->name('products.featured');
	Route::post('/pekerja/published', 'ProductController@updatePublished')->name('products.published');
